    ...
    <body>
        <div class="loginBack">
            <form action="#" class="loginPage">
                ...
                <button class="loginSubmit" type="submit">로그인</button>
                <button class="registerSubmit" type="submit">회원가입</button>
            </form>
        </div>
...
postDescriptionContent: (post) =>{
    ...
    <div class="list-box d-flex">
        ...
        <div class="buttons d-flex">
            ...
            <form action="http://localhost:3001/processDelete" method="post">
